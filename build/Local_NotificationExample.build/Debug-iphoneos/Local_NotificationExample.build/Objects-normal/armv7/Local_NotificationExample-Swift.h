...
SWIFT_CLASS("_TtC25Local_NotificationExample11AppDelegate")
...
- (void)testGimbel:(NSString * __nonnull)string;
- (NSString * __nonnull)getApplicationStatus;
...
SWIFT_CLASS("_TtC25Local_NotificationExample14ViewController")
...
@property (nonatomic, copy) NSArray * __nonnull msgArray;
- (void)viewDidLoad;
- (BOOL)isBusinessHour;
- (void)localNotificationCall;
